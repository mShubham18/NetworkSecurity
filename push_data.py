...
# It is a python package that provides Mozilla's CA Bundle.
# It is used to validate the clients's request to the server.
import certifi
ca = certifi.where()
...
if __name__=="__main__":
    FILEPATH= "Network_Data\PhishingData.csv"
